# Generated by Django 4.1.4 on 2023-02-04 21:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('modified_at', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('encuser', models.ForeignKey(default='', max_length=100, on_delete=django.db.models.deletion.CASCADE, to='RESEAU.encuser')),
                ('patient', models.ForeignKey(default='', max_length=25, on_delete=django.db.models.deletion.CASCADE, to='RESEAU.patient')),
            ],
        ),
        migrations.CreateModel(
            name='Appartenir',
